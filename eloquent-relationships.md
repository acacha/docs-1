...
Suppose we want to implement an app to send notifications to a group of users. Notifications are sent to groups of users using a `Notification` model with the following table:
